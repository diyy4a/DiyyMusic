...
DiyyMusic 0.6.1 removes the former application UI source tree and replaces it with a new Compose interface based on the supplied **Apple Music Player Redesign (Community)** Figma reference.

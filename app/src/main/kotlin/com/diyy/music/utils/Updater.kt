...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/diyy4a/DiyyMusic"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "DiyyMusic.apk" -> "universal" to "foss"
                name == "DiyyMusic-with-Google-Cast.apk" -> "universal" to "gms"

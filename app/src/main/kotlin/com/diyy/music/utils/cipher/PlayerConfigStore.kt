package com.diyy.music.utils.cipher
...
object PlayerConfigStore {
    private const val TAG = "DiyyMusic_CipherConfig"
    ...
    // zemer has already solved is fixed fleet-wide without a DiyyMusic-fix APK release.

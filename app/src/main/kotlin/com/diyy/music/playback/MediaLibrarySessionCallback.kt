...
import com.diyy.music.constants.AndroidAutoSectionsOrderKey
import com.diyy.music.constants.AndroidAutoYouTubePlaylistsKey
import com.diyy.music.playback.AndroidAutoSection
import com.diyy.music.playback.deserializeSections
import com.diyy.music.playback.serializeSections
                ...
                when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.diyy.innertube.pages.HomePage.Section>()

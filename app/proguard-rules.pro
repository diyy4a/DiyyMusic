...
# Since DiyyMusic is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.diyy.music.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.diyy.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class com.diyy.music.utils.cipher.** { *; }
-keep class com.diyy.music.utils.potoken.** { *; }
...
-keep class com.diyy.music.models.PersistQueue { *; }
-keep class com.diyy.music.models.PersistPlayerState { *; }
-keep class com.diyy.music.models.QueueData { *; }
-keep class com.diyy.music.models.QueueType { *; }
-keep class com.diyy.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.diyy.music.cast.** { *; }
...
-keep class com.diyy.music.recognition.VibraSignature { *; }
-keepclassmembers class com.diyy.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.diyy.music.listentogether.proto.** { *; }
-keepclassmembers class com.diyy.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.diyy.shazamkit.models.** { *; }
-keepclassmembers class com.diyy.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.diyy.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.diyy.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.diyy.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}

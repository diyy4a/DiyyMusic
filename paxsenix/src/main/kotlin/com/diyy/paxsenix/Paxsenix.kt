package com.diyy.paxsenix

import android.content.Context
import com.diyy.music.betterlyrics.TTMLParser
import com.diyy.paxsenix.models.AppleMusicSearchResponse
import com.diyy.paxsenix.models.LyricsResponse

import com.diyy.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "DiyyMusic/$appVersion")
                }
